...
interface Site {
  name: string;
  address: string;
  icon: IconTypes; // Иконка с пропсами
}
...
const servicesList: Site[] = [
  ...
  { name: 'Youtube Music', address: 'https://music.youtube.com', icon: SiYoutubemusic },
  ...
  { name: 'Gemini', address: 'https://gemini.google.com/app', icon: OcSparklefill2 },
